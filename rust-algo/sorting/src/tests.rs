...
mod tests {
    ...
    pub fn check_sorts() {
        ...
        let v_int1 = vec![7, 17, 18, 25, 28, 47, 53, 62, 69, 83, 86, 95];
        let v_int2 = vec![4, 7, 8, 9, 11, 14, 15, 16, 18, 21, 22, 23, 23, 25, 28, 29, 30];
        let v_int3: Vec<usize> = (0..20).collect();
        ...
        check_sort(&v_int3, selection::sort);
        ...
        check_sort(&v_int3, insertion::sort);
