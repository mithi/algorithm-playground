```
 NOTES BY:DV Klopfenstein
 LINK: https://github.com/dvklopfenstein/PrincetonAlgorithms/blob/master/py/AlgsSedgewickWayne/WeightedQuickUnionPlusUF.py
 LECTURES FROM: Robert Sedgewick and Kevin Wayne.
 SEE ALSO: https://github.com/dvklopfenstein/PrincetonAlgorithms/blob/master/doc/README_Union_Find.md
 ...
 * Iterate until satisfied. (Find a new algorithm)
...
##########################################################################
 Question 3
 Which of the followint id[] arrays(s) could be the result of running
 the weights quick union algorithm on a set of 10 items? Check all that apply
